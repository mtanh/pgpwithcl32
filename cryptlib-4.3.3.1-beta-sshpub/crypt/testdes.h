...
static const DES_TEST FAR_DATA testIP[ 64 ] = {
...
static const DES_TEST FAR_DATA testVP[ 64 ] = {
	{ { 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01 },
	  { 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
	  { 0x95, 0xF8, 0xA5, 0xE5, 0xDD, 0x31, 0xD9, 0x00 } },
	{ { 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01 },
...
static const DES_TEST FAR_DATA testKP[ 56 ] = {
...
static const DES_TEST FAR_DATA testRS[ 56 ] = {
	{ { 0x80, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01 },
	  { 0x95, 0xA8, 0xD7, 0x28, 0x13, 0xDA, 0xA9, 0x4D },
	  { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
	{ { 0x40, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01 },
...
static const DES_TEST FAR_DATA testDP[ 32 ] = {
...
static const DES_TEST FAR_DATA testSB[ 19 ] = {
