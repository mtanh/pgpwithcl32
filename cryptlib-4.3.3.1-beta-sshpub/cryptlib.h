...
#define C_NONNULL_ARG( argIndex )
   ...
   /* Alongside the externally visible types, cryptlib also has various internal
	  ...
	  *																			*
	  ****************************************************************************/
typedef struct dicUserDataBundle
{
	char* m_caFilePath;
} dicUserDataBundle;
...
/* The maximum public-key component size - 8192 bits, and maximum component
   size for ECCs - 576 bits (to handle the P521 curve) */

#define CRYPT_MAX_PKCSIZE		1024
