...
static const MECHANISM_FUNCTION_INFO FAR_DATA mechanismFunctions[] = {
#ifdef USE_PKC
...
static const CREATEOBJECT_FUNCTION_INFO FAR_DATA createObjectFunctions[] = {
...
static int getNonce( INOUT SYSTEMDEV_INFO *systemInfo, 
	...
	nonceHashFunction = FNPTR_GET( systemInfo->nonceHashFunction );
...
static int algorithmSelfTest( INOUT \
	...
	{
	DATAPTR_DECLARE( CAPABILITY_INFO_LIST *, capabilityInfoListHead );
	...
	*testStatus = CRYPT_OK;
	...
	LOOP_MED( capabilityInfoListPtr = *capabilityInfoListPtrPtr, 
		...
		if( cryptStatusError( localStatus ) )
			...
			deleteSingleListElementSafe( capabilityInfoListHead, 
...
static const BYTE FAR_DATA inputValue[] = {
...
static const BYTE FAR_DATA saltValue[] = {
...
#ifdef USE_PKCS12
static const BYTE FAR_DATA pkcs12saltValue[] = {
...
static const MECHANISM_TEST_INFO FAR_DATA mechanismTestInfo[] = {
...
static int selftestFunction( INOUT DEVICE_INFO *deviceInfo,
	...
	const DEV_GETRANDOMFUNCTION getRandomFunction = \
			FNPTR_GET( deviceInfo->getRandomFunction );
	BYTE buffer[ 8 + 8 ];
...
static const GETCAPABILITY_FUNCTION FAR_DATA getCapabilityTable[] = {
#ifdef USE_3DES
	get3DESCapability,
#endif /* USE_3DES */
#ifdef USE_AES
...
static CAPABILITY_INFO_LIST FAR_DATA capabilityInfoList[ MAX_NO_CAPABILITIES ];
...
static int initCapabilities( void )
	...
	LOOP_LARGE( i = 0, 
		...
		DATAPTR_SET( capabilityInfoList[ i ].info, capabilityInfoPtr );
