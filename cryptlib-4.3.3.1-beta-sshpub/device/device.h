...
#define DEVICE_NEEDSCLEANUP	0x0040	/* Device partially initialised */
...
typedef struct {
	...
	FNPTR_DECLARE( HASH_FUNCTION_ATOMIC, nonceHashFunction );
	int nonceHashSize;
...
typedef struct DI {
	...
	DATAPTR_DECLARE( const void *, capabilityInfoList );
	...
	FNPTR_DECLARE( DEV_INITFUNCTION, initFunction );
	FNPTR_DECLARE( DEV_SHUTDOWNFUNCTION, shutdownFunction );
	FNPTR_DECLARE( DEV_CONTROLFUNCTION, controlFunction );
	FNPTR_DECLARE( DEV_SELFTESTFUNCTION, selftestFunction );
	FNPTR_DECLARE( DEV_GETITEMFUNCTION, getItemFunction );
	FNPTR_DECLARE( DEV_SETITEMFUNCTION, setItemFunction );
	FNPTR_DECLARE( DEV_DELETEITEMFUNCTION, deleteItemFunction );
	FNPTR_DECLARE( DEV_GETFIRSTITEMFUNCTION, getFirstItemFunction );
	FNPTR_DECLARE( DEV_GETNEXTITEMFUNCTION, getNextItemFunction );
	FNPTR_DECLARE( DEV_GETRANDOMFUNCTION, getRandomFunction );
