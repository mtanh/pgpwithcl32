...
static int writeCRLInfo( INOUT STREAM *stream, 
	...
	LOOP_MAX( revocationInfo = certRevInfo->revocations, 
			  revocationInfo != NULL,
...
static int writeRtcsRequestInfo( INOUT STREAM *stream, 
	...
	LOOP_LARGE( validityInfo = certValInfo->validityInfo, 
				validityInfo != NULL,
...
static int writeRtcsResponseInfo( INOUT STREAM *stream,
	...
	CERT_VAL_INFO *certValInfo = subjectCertInfoPtr->cCertVal;
	VALIDITY_INFO *validityInfo;
	int extensionSize, validityInfoLength = 0;
	int status, LOOP_ITERATOR;
...
static int writeOcspRequestInfo( INOUT STREAM *stream, 
	...
	LOOP_LARGE( revocationInfo = certRevInfo->revocations, 
				revocationInfo != NULL,
				revocationInfo = revocationInfo->next )
		{
...
static const CERTWRITE_INFO FAR_DATA certWriteTable[] = {
