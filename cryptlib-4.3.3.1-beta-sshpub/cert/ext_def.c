...
/* Forward declarations for alternative encoding tables used by the main 
  ...
  static const ATTRIBUTE_INFO FAR_DATA generalNameInfo[];
  static const ATTRIBUTE_INFO FAR_DATA holdInstructionInfo[];
  static const ATTRIBUTE_INFO FAR_DATA contentTypeInfo[];
#else
  extern const ATTRIBUTE_INFO FAR_DATA generalNameInfo[];
  extern const ATTRIBUTE_INFO FAR_DATA holdInstructionInfo[];
  extern const ATTRIBUTE_INFO FAR_DATA contentTypeInfo[];
#endif /* gcc 4.x */
...
static const ATTRIBUTE_INFO FAR_DATA extensionInfo[] = {
#ifdef USE_CERTREQ
	/* challengePassword:
...
STATIC_DATA const ATTRIBUTE_INFO FAR_DATA holdInstructionInfo[] = {
...
STATIC_DATA const ATTRIBUTE_INFO FAR_DATA generalNameInfo[] = {
	/* otherName */
...
static const ATTRIBUTE_INFO FAR_DATA cmsAttributeInfo[] = {
	/* contentType:
...
STATIC_DATA const ATTRIBUTE_INFO FAR_DATA contentTypeInfo[] = {
