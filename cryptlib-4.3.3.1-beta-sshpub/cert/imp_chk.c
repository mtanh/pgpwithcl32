...
static int processCertWrapper( INOUT STREAM *stream, 
	...
	{
	static const CMS_CONTENT_INFO FAR_DATA oidInfoSignedData = { 1, 3 };
	static const OID_INFO FAR_DATA signedDataOIDinfo[] = {
		{ OID_CMS_SIGNEDDATA, CRYPT_OK, &oidInfoSignedData },
		{ NULL, 0 }, { NULL, 0 }
		};
	static const OID_INFO FAR_DATA dataOIDinfo[] = {
