...
static const CMS_CONTENT_INFO FAR_DATA oidInfoPkcs15Data = { 0, 0 };

static const OID_INFO FAR_DATA keyFileOIDinfo[] = {
	{ OID_PKCS15_CONTENTTYPE, TRUE, &oidInfoPkcs15Data },
	{ OID_CMS_AUTHDATA, FALSE, &oidInfoPkcs15Data },
	{ NULL, 0 }, { NULL, 0 }
	};
static const OID_INFO FAR_DATA keyFilePKCS15OIDinfo[] = {
...
static BOOLEAN sanityCheckPKCS15( const PKCS15_INFO *pkcs15infoPtr )
	...
	if( pkcs15infoPtr->type <= PKCS15_SUBTYPE_NONE || \
		...
		{
		DEBUG_PRINT(( "sanityCheckPKCS15: General info" ));
		return( FALSE );
		}
	if( pkcs15infoPtr->labelLength < 0 || \
		pkcs15infoPtr->labelLength > CRYPT_MAX_TEXTSIZE )
		{
		DEBUG_PRINT(( "sanityCheckPKCS15: Label" ));
		return( FALSE );
		}
	if( pkcs15infoPtr->type == PKCS15_SUBTYPE_SECRETKEY || \
		...
		if( pkcs15infoPtr->iDlength != 0 || \
			...
			{
			DEBUG_PRINT(( "sanityCheckPKCS15: Spurious ID" ));
			return( FALSE );
			}
		}
	else
		...
		if( pkcs15infoPtr->iDlength <= 0 || \
			...
			{
			DEBUG_PRINT(( "sanityCheckPKCS15: IDs" ));
			return( FALSE );
			}
		}
	...
	if( pkcs15infoPtr->iAndSIDlength < 0 || \
		...
		{
		DEBUG_PRINT(( "sanityCheckPKCS15: Subject/issuer ID" ));
		return( FALSE );
		}
	if( pkcs15infoPtr->pgp2KeyIDlength < 0 || \
		...
		{
		DEBUG_PRINT(( "sanityCheckPKCS15: PGP ID" ));
		return( FALSE );
		}
	...
	if( pkcs15infoPtr->pubKeyData != NULL )
		...
		if( pkcs15infoPtr->pubKeyDataSize <= 0 || \
			...
			{
			DEBUG_PRINT(( "sanityCheckPKCS15: Public key data" ));
			return( FALSE );
			}
		}
	else
		...
		if( pkcs15infoPtr->pubKeyDataSize != 0 || \
			pkcs15infoPtr->pubKeyOffset != 0 )
			{
			DEBUG_PRINT(( "sanityCheckPKCS15: Spurious public key data" ));
			return( FALSE );
			}
		}
	if( pkcs15infoPtr->privKeyData != NULL )
		...
		if( pkcs15infoPtr->privKeyDataSize <= 0 || \
			...
			{
			DEBUG_PRINT(( "sanityCheckPKCS15: Private key data" ));
			return( FALSE );
			}
		}
	else
		...
		if( pkcs15infoPtr->privKeyDataSize != 0 || \
			pkcs15infoPtr->privKeyOffset != 0 )
			{
			DEBUG_PRINT(( "sanityCheckPKCS15: Spurious private key data" ));
			return( FALSE );
			}
		}
	if( pkcs15infoPtr->certData != NULL )
		...
		if( pkcs15infoPtr->certDataSize <= 0 || \
			...
			{
			DEBUG_PRINT(( "sanityCheckPKCS15: Certificate data" ));
			return( FALSE );
			}
		}
	else
		...
		if( pkcs15infoPtr->certDataSize != 0 || \
			pkcs15infoPtr->certOffset != 0 )
			{
			DEBUG_PRINT(( "sanityCheckPKCS15: Spurious certificate data" ));
			return( FALSE );
			}
		}
