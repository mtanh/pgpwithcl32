...
static const FAR_DATA OID_INFO keyCertBagOIDinfo[] = {
...
static const FAR_DATA OID_INFO certBagOIDinfo[] = {
	{ OID_PKCS12_CERTBAG, 0 },
	{ NULL, 0 }, { NULL, 0 }
	};
static const FAR_DATA OID_INFO certOIDinfo[] = {
...
static const FAR_DATA OID_INFO encryptionOIDinfo[] = {
...
static const FAR_DATA OID_INFO attributeOIDinfo[] = {
...
static int isIncorrectNestedContent( INOUT STREAM *stream, 
	...
	REQUIRES_B( contentLength > 0 && contentLength < MAX_INTLENGTH_SHORT );
