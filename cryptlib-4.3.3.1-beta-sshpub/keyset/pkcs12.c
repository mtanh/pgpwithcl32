...
static const FAR_DATA OID_INFO dataOIDinfo[] = {
...
static BOOLEAN sanityCheckPKCS12( const PKCS12_INFO *pkcs12infoPtr )
	...
	if( pkcs12infoPtr->labelLength == 0 )
		...
		if( pkcs12infoPtr->idLength < 0 || \
			...
			{
			DEBUG_PRINT(( "sanityCheckPKCS12: ID" ));
			return( FALSE );
			}
		}
	else
		...
		if( pkcs12infoPtr->labelLength <= 0 || \
			...
			pkcs12infoPtr->idLength > CRYPT_MAX_HASHSIZE )
			{
			DEBUG_PRINT(( "sanityCheckPKCS12: Label/ID" ));
			return( FALSE );
			}
		}
	...
	if( objectInfoPtr->data != NULL )
		...
		if( objectInfoPtr->dataSize <= 0 || \
			...
			{
			DEBUG_PRINT(( "sanityCheckPKCS12: Key data/payload" ));
			return( FALSE );
			}
		}
	else
		...
		if( objectInfoPtr->dataSize != 0 || \
			...
			objectInfoPtr->payloadSize != 0 )
			{
			DEBUG_PRINT(( "sanityCheckPKCS12: Spurious key data/payload" ));
			return( FALSE );
			}
		}
	if( objectInfoPtr->keySize < 0 || \
		...
		{
		DEBUG_PRINT(( "sanityCheckPKCS12: Key salt/iterations" ));
		return( FALSE );
		}
	...
	if( objectInfoPtr->data != NULL )
		...
		if( objectInfoPtr->dataSize <= 0 || \
			...
			objectInfoPtr->payloadSize > objectInfoPtr->dataSize )
			{
			DEBUG_PRINT(( "sanityCheckPKCS12: Cert data/payload" ));
			return( FALSE );
			}
		}
	else
		...
		if( objectInfoPtr->dataSize != 0 || \
			...
			objectInfoPtr->payloadSize != 0 )
			{
			DEBUG_PRINT(( "sanityCheckPKCS12: Spurious cert data/payload" ));
			return( FALSE );
			}
		}
	if( objectInfoPtr->keySize < 0 || \
		...
		objectInfoPtr->iterations > MAX_KEYSETUP_ITERATIONS )
		{
		DEBUG_PRINT(( "sanityCheckPKCS12: Cert salt/iterations" ));
		return( FALSE );
		}
	...
	if( pkcs12infoPtr->macSaltSize < 0 || \
		...
		{
		DEBUG_PRINT(( "sanityCheckPKCS12: MAC info" ));
		return( FALSE );
		}
