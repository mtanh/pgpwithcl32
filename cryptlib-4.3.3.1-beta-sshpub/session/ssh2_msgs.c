...
typedef struct {
	...
	const char FAR_DATA *requestName;/* String form of request type */
...
typedef struct {
	...
	const char FAR_DATA *channelName;/* String form of channel type */
...
static const CHANNEL_TYPE_INFO FAR_DATA channelInfo[] = {
	{ "session", 7, FALSE },
#ifdef USE_SSH_EXTENDED
...
static const REQUEST_TYPE_INFO FAR_DATA requestInfo[] = {
