...
static int initPubkeyAlgo( INOUT SESSION_INFO *sessionInfoPtr,
	...
	{
	static const ALGO_STRING_INFO FAR_DATA algoStringPubkeyRSATbl[] = {
	...
	static const ALGO_STRING_INFO FAR_DATA algoStringPubkeyDSATbl[] = {
		{ "ssh-dss", 7, CRYPT_ALGO_DSA, CRYPT_ALGO_SHA1 },
		{ NULL, 0, CRYPT_ALGO_NONE, CRYPT_ALGO_NONE }, 
			{ NULL, 0, CRYPT_ALGO_NONE, CRYPT_ALGO_NONE }
		};
#ifdef USE_ECDSA
	static const ALGO_STRING_INFO FAR_DATA algoStringPubkeyECDSATbl[] = {
		{ "ecdsa-sha2-nistp256", 19, CRYPT_ALGO_ECDSA, CRYPT_ALGO_SHA2 },
		{ NULL, 0, CRYPT_ALGO_NONE, CRYPT_ALGO_NONE }, 
			{ NULL, 0, CRYPT_ALGO_NONE, CRYPT_ALGO_NONE }
		};
	static const ALGO_STRING_INFO FAR_DATA algoStringPubkeyECDSA384Tbl[] = {
		{ "ecdsa-sha2-nistp384", 19, CRYPT_ALGO_ECDSA, CRYPT_ALGO_SHA2 },
		{ NULL, 0, CRYPT_ALGO_NONE, CRYPT_ALGO_NONE }, 
			{ NULL, 0, CRYPT_ALGO_NONE, CRYPT_ALGO_NONE }
		};
	static const ALGO_STRING_INFO FAR_DATA algoStringPubkeyECDSA521Tbl[] = {
...
static int processDHE( INOUT SESSION_INFO *sessionInfoPtr,
	...
	if( sessionInfoPtr->sessionSSH->packetType == SSH_MSG_KEX_DH_GEX_REQUEST )
		...
		DEBUG_PRINT(( "Client specified key size range %d...%d (%d "
					  "preferred) bits", minKeySize, status, keySize ));
		...
		DEBUG_PRINT(( "Client specified key size %d bits", keySize ));
		}
	if( !cryptStatusError( status ) )
		{
