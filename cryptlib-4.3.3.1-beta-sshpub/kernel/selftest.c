...
static BOOLEAN testSafetyMechanisms( void )
	...
	if( DATAPTR_GET( testPtr ) != &testBool )
		return( FALSE );
	testPtr2 ^= 0x0800;		/* Hidden variable used to check testPtr */
	if( DATAPTR_ISVALID( testPtr ) || DATAPTR_GET( testPtr ) != NULL )
		return( FALSE );
...
static BOOLEAN testKernelMechanisms( void )
	...
	static const BYTE FAR_DATA key[] = \
		{ 0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07,
		  0x08, 0x09, 0x0A, 0x0B, 0x0C, 0x0D, 0x0E, 0x0F };
	/* AES FIPS test keys */
	static const BYTE FAR_DATA iv[] = \
