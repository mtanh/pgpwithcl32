...
static const COMPARE_ACL FAR_DATA compareACLTbl[] = {
	/* Hash/MAC value */
...
static const CHECK_ACL FAR_DATA checkACLTbl[] = {
...
static const ATTRIBUTE_ACL_ALT FAR_DATA formatPseudoACL[] = {
...
static const CREATE_ACL FAR_DATA deviceSpecialACL[] = {
...
static const CREATE_ACL FAR_DATA createObjectACL[] = {
	/* Context object */
	{ OBJECT_TYPE_CONTEXT,
...
static const CREATE_ACL FAR_DATA certSpecialACL[] = {
...
static const CREATE_ACL FAR_DATA createObjectIndirectACL[] = {
...
static BOOLEAN checkAttributeRangeWidechar( const void *value,
	...
	REQUIRES_B( minLength > 0 && minLength < MAX_INTLENGTH_SHORT );
	REQUIRES_B( maxLength > 0 && maxLength < MAX_INTLENGTH_SHORT );
...
int preDispatchCheckAttributeAccess( IN_HANDLE const int objectHandle,
									 ...
									 IN TYPECAST( ATTRIBUTE_ACL * ) \
										const void *auxInfo )
	{
	static const int FAR_DATA accessTypeTbl[ 7 ][ 2 ] = {
	...
	accessType = accessTypeTbl[ localMessage - MESSAGE_GETATTRIBUTE ]\
							  [ ( objectInfoPtr->flags & OBJECT_FLAG_HIGH ) ? 1 : 0 ];
...
int preDispatchCheckTrustMgmtAccess( IN_HANDLE const int objectHandle, 
									 ...
									 STDC_UNUSED const void *dummy )
	{
	static const OBJECT_ACL FAR_DATA objectTrustedCertificate = {
			ST_CERT_CERT | ST_CERT_CERTCHAIN, ST_NONE, ST_NONE, 
			ACL_FLAG_HIGH_STATE | ACL_FLAG_ROUTE_TO_CERT };
	static const ATTRIBUTE_ACL FAR_DATA trustMgmtPseudoACL[] = {
		MKACL_O(
