...
typedef struct {
	...
	DATAPTR_DECLARE( void *, objectPtr );/* Object data */
...
typedef struct {
	...
	DATAPTR_DECLARE( const void *, handlingInfoPtr );/* Message handling info */
	MESSAGE_TYPE message;
	DATAPTR_DECLARE( const void *, messageDataPtr );
...
typedef struct {
	...
	DATAPTR_DECLARE( void *, allocatedListHead );
	DATAPTR_DECLARE( void *, allocatedListTail );
#ifdef USE_THREADS
