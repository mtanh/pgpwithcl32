...
static const MECHANISM_ACL FAR_DATA mechanismWrapACL[] = {
	/* PKCS #1 encrypt */
	{ MECHANISM_ENC_PKCS1,
...
static const MECHANISM_ACL FAR_DATA mechanismUnwrapACL[] = {
	/* PKCS #1 decrypt */
	{ MECHANISM_ENC_PKCS1,
	  { MKACP_S_OPT( MIN_PKCSIZE,			/* Wrapped key */
					 MAX_PKCENCRYPTED_SIZE ),
...
static const MECHANISM_ACL FAR_DATA mechanismSignACL[] = {
	/* PKCS #1 sign */
	{ MECHANISM_SIG_PKCS1,
...
static const MECHANISM_ACL FAR_DATA mechanismSigCheckACL[] = {
	/* PKCS #1 sig check */
	{ MECHANISM_SIG_PKCS1,
...
static const MECHANISM_ACL FAR_DATA mechanismDeriveACL[] = {
	/* PKCS #5 derive */
...
static const MECHANISM_ACL FAR_DATA mechanismKDFACL[] = {
	/* PKCS #5 KDF */
	{ MECHANISM_DERIVE_PKCS5,
