...
typedef struct {
	...
	int flags;						/* PKC information flags */
...
typedef struct CI {
	...
	DATAPTR_DECLARE( CAPABILITY_INFO *, capabilityInfo );	
									/* Encryption capability info */
...
int checkCapability( const CAPABILITY_INFO FAR_DATA *capabilityInfoPtr );
