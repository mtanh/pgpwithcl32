...
static int selfTest( void )
	...
	LOOP_SMALL( i = 0, digestValues[ i ].data != NULL, i++ )
		{
...
static int initParams( INOUT CONTEXT_INFO *contextInfoPtr, 
	...
	if( paramType == KEYPARAM_BLOCKSIZE )
		{
#ifdef USE_SHA2_EXT
		static const CAPABILITY_INFO FAR_DATA capabilityInfoSHA384 = {
		...
		static const CAPABILITY_INFO FAR_DATA capabilityInfoSHA512 = {
