...
/* Every systems has its own way of indicating a timeout and a nonblocking
   connect error.  The following pseudo-error codes are mapped to the 
   appropriate system-specific values */

#if defined( __WINDOWS__ )
  #define TIMEOUT_ERROR			WSAETIMEDOUT	/* Timeout error */
  #define NONBLOCKCONNECT_ERROR WSAECONNREFUSED	/* Nonblock-conn.error */
#elif defined( __MQXRTOS__ )
  #define TIMEOUT_ERROR			RTCSERR_TCP_TIMED_OUT	/* Timeout error */
  #define NONBLOCKCONNECT_ERROR RTCSERR_TCP_CONN_REFUSED	/* Nonblock-conn.error */
#elif defined( __Nucleus__ )
  #define TIMEOUT_ERROR			NU_TIMEOUT		/* Timeout error */
  #define NONBLOCKCONNECT_ERROR NU_CONNECTION_REFUSED	/* Nonblock-conn.error */
#else
  #define TIMEOUT_ERROR			ETIMEDOUT		/* Timeout error */
  #define NONBLOCKCONNECT_ERROR ECONNREFUSED	/* Nonblock-conn.error */
