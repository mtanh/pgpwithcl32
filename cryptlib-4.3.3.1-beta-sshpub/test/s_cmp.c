...
typedef struct {
	const char FAR_DATA *name;
	const C_CHR FAR_DATA *url, FAR_DATA *user, FAR_DATA *password, FAR_DATA *revPassword;
	} CA_INFO;

static const CA_INFO FAR_DATA caInfoTbl[] = {
...
static const CERT_DATA FAR_DATA cmpPkiUserFullDNData[] = {
...
static const CERT_DATA FAR_DATA cmpPkiUserPartialDNData[] = {
	/* Identification information */
	{ CRYPT_CERTINFO_COUNTRYNAME, IS_STRING, 0, TEXT( "NZ" ) },
	{ CRYPT_CERTINFO_ORGANIZATIONNAME, IS_STRING, 0, TEXT( "Dave's Wetaburgers" ) },
	{ CRYPT_CERTINFO_ORGANIZATIONALUNITNAME, IS_STRING, 0, TEXT( "Procurement" ) },
...
static const CERT_DATA FAR_DATA cmpPkiUserCaData[] = {
	/* Identification information */
	{ CRYPT_CERTINFO_COUNTRYNAME, IS_STRING, 0, TEXT( "NZ" ) },
	{ CRYPT_CERTINFO_ORGANIZATIONNAME, IS_STRING, 0, TEXT( "Dave's Wetaburgers" ) },
	{ CRYPT_CERTINFO_ORGANIZATIONALUNITNAME, IS_STRING, 0, TEXT( "Procurement" ) },
...
static const CERT_DATA FAR_DATA cmpPkiUserRaData[] = {
	/* Identification information */
	{ CRYPT_CERTINFO_COUNTRYNAME, IS_STRING, 0, TEXT( "NZ" ) },
	{ CRYPT_CERTINFO_ORGANIZATIONNAME, IS_STRING, 0, TEXT( "Dave's Wetaburgers" ) },
	{ CRYPT_CERTINFO_ORGANIZATIONALUNITNAME, IS_STRING, 0, TEXT( "Procurement" ) },
...
static const CERT_DATA FAR_DATA cmpCryptlibRequestNoDNData[] = {	/* For ir */
...
static const CERT_DATA FAR_DATA cmpCryptlibRequestData[] = {		/* For cr */
...
static const CERT_DATA FAR_DATA cmpCryptlibDsaRequestData[] = {	/* Unused */
	/* Identification information */
	{ CRYPT_CERTINFO_COUNTRYNAME, IS_STRING, 0, TEXT( "NZ" ) },
	{ CRYPT_CERTINFO_ORGANIZATIONNAME, IS_STRING, 0, TEXT( "Dave's Wetaburgers" ) },
	{ CRYPT_CERTINFO_ORGANIZATIONALUNITNAME, IS_STRING, 0, TEXT( "Procurement" ) },
...
static const CERT_DATA FAR_DATA cmpRsaSignRequestData[] = {		/* For cr */
	/* Identification information */
...
static const CERT_DATA FAR_DATA cmpRsaEncryptRequestData[] = {	/* Unused */
	/* Identification information */
#ifdef SERVER_FIXED_DN
	{ CRYPT_CERTINFO_COUNTRYNAME, IS_STRING, 0, TEXT( "KR" ) },
	{ CRYPT_CERTINFO_ORGANIZATIONNAME, IS_STRING, 0, TEXT( "INITECH" ) },
...
static const CERT_DATA FAR_DATA cmpRsaCaRequestData[] = {		/* For ir-CA */
	/* Identification information */
	{ CRYPT_CERTINFO_COUNTRYNAME, IS_STRING, 0, TEXT( "NZ" ) },
	{ CRYPT_CERTINFO_ORGANIZATIONNAME, IS_STRING, 0, TEXT( "Dave's Wetaburgers" ) },
	{ CRYPT_CERTINFO_ORGANIZATIONALUNITNAME, IS_STRING, 0, TEXT( "Procurement" ) },
...
static int connectCMPFail( const int count )
	{
	static const CERT_DATA FAR_DATA cmpFailRequestData1[] = {
	...
	static const CERT_DATA FAR_DATA cmpFailRequestData2[] = {
	...
	static const CERT_DATA FAR_DATA cmpFailRequestData3[] = {
	...
	static const CERT_DATA FAR_DATA *cmpFailRequestDataTbl[] = {
...
static int cmpClientServer( const CMP_TEST_TYPE testType )
	...
	status = connectCryptlibCMP( testType, CRYPT_ALGO_RSA );
...
int testSessionCMPClientServer( void )
	{
	return( cmpClientServer( CMP_TEST_NORMAL ) );
	}
