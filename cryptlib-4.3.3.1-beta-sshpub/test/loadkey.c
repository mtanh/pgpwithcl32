...
printf("static const RSA_KEY FAR_DATA rsaTestKey = {\n");
...
#include <stdio.h>
	...
	printf("static const DLP_KEY FAR_DATA dlpTestKey = {\n");
...
static const RSA_KEY FAR_DATA rsa1024TestKey = {
	/* n */
	1024,
...
static const RSA_KEY FAR_DATA rsa2048TestKey = {
	/* n */
	2048,
...
static const DLP_KEY FAR_DATA dlp1024TestKey = {
	/* p */
	1024,
...
static const BYTE FAR_DATA dh1024SPKI[] = {
	0x30, 0x82, 0x01, 0x21,
		0x30, 0x82, 0x01, 0x17,
...
static const ECC_KEY FAR_DATA eccP256TestKey = {
#if 0
	CRYPT_ECCCURVE_NONE,
	/* p */
	256,
