...
typedef struct AI {
	...
	DATAPTR_DECLARE( struct AI *, next );	/* Next item in the list */
...
typedef struct CL {
	...
	DATAPTR_DECLARE( struct CL *, prev );
	DATAPTR_DECLARE( struct CL *, next );	/* Prev, next items in the list */
...
typedef struct EI {
	...
	DATAPTR_DECLARE( ACTION_LIST *, preActionList );
	DATAPTR_DECLARE( ACTION_LIST *, actionList );
	DATAPTR_DECLARE( ACTION_LIST *, postActionList );
	...
	DATAPTR_DECLARE( ACTION_LIST *, lastAction );
	...
	/* When de-enveloping we may have objects present that can't be used
	   ...
	   traversing the list */
	DATAPTR_DECLARE( CONTENT_LIST *, contentList );
	DATAPTR_DECLARE( CONTENT_LIST *, contentListCurrent );
